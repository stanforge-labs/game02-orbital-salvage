...
for(const n of ['ProcLoot','ProcScrap','ProcEnergy','ProcData','ProcHeavy','ProcDecor','ProcHazard','ProcPOI','RegionReveal','G13Signal','G13Key','G13Gate','G13Cache','Laser13','Emitter13','CorridorWall','ShipModules','MeteorTelegraph','Dev13Panel','Dev13Text','ModalDim13'])layout.instances=layout.instances.filter(i=>i.name!==n);
...
add('ModalDim13','DamageFlash',{x:0,y:0,width:1920,height:1080,zOrder:8,layer:'HUD'});
...
for(const item of layout.instances.filter(i=>i.name==='SecretLabel'))Object.assign(item,{x:720,y:920,width:480,height:52,layer:'HUD',zOrder:31});
