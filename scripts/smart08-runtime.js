...
const worldSafe08=(o)=>{const left=(o.getX()-runtimeScene.__osCam.x)*2+960,right=left+o.getWidth()*2,top=(o.getY()-runtimeScene.__osCam.y)*2+540,bottom=top+o.getHeight()*2;if(left<40||right>1880||top<230||bottom>920)o.hide();};for(const n of ['StationLabel','RouteLabel','DangerLabel','RiskLabel'])for(const o of runtimeScene.getObjects(n))if(!o.isHidden())worldSafe08(o);
