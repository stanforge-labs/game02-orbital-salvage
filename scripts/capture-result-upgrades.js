...
(async () => {
  ...
  await page.screenshot({ path: 'C:\\Yandex Games\\02 Orbital Salvage\\screenshots\\CorePass02\\09-return.png' });
  await move(['ArrowLeft', 'ArrowDown'], 1300);
  await page.waitForTimeout(350);
  await page.screenshot({ path: 'C:\\Yandex Games\\02 Orbital Salvage\\screenshots\\CorePass02\\10-result.png' });
  await page.mouse.click(480, 395);
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'C:\\Yandex Games\\02 Orbital Salvage\\screenshots\\CorePass02\\11-upgrades.png' });
  process.exit(0);
})();
