...
$zipPath = Join-Path $releaseRoot 'OrbitalSalvage_Yandex_1.0.0.zip'
...
Set-Content -LiteralPath (Join-Path $releaseRoot 'OrbitalSalvage_Yandex_1.0.0_SHA256.txt') -Value ($hash+'  OrbitalSalvage_Yandex_1.0.0.zip') -Encoding ascii
