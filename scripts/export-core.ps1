...
if ($data.Contains('Рљ') -or $data.Contains('Рђ') -or $data.Contains('Рџ')) {
...
$imageFiles = @('background_space.png', 'space_haze.png', 'station_glow.png', 'station_custom.png', 'ship_player.png', 'salvage_scrap.png', 'salvage_panel.png', 'salvage_hull.png', 'salvage_satellite.png', 'salvage_antenna.png', 'scrap_glow.png', 'rare_container.png', 'hazard_debris.png', 'hazard_fast.png', 'debris_field.png', 'danger_zone.png', 'rotate_device.png', 'vfx_fire01.png', 'ui_bar_blue.png', 'ui_panel.png', 'ui_button.png', 'favicon.ico')
...
$usedResources = '[{"name":"background_space.png"},{"name":"space_haze.png"},{"name":"station_glow.png"},{"name":"station_custom.png"},{"name":"ship_player.png"},{"name":"salvage_scrap.png"},{"name":"salvage_panel.png"},{"name":"salvage_hull.png"},{"name":"salvage_satellite.png"},{"name":"salvage_antenna.png"},{"name":"scrap_glow.png"},{"name":"rare_container.png"},{"name":"hazard_debris.png"},{"name":"hazard_fast.png"},{"name":"debris_field.png"},{"name":"danger_zone.png"},{"name":"rotate_device.png"},{"name":"vfx_fire01.png"},{"name":"ui_bar_blue.png"},{"name":"ui_panel.png"},{"name":"ui_button.png"},{"name":"Exo2-Variable.ttf"}]'
